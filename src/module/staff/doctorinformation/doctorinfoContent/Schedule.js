...
const Listdata = [
    {
        ...
        name1: ' The answers are measured on a scale of 1 to 5, with 5 being the best score equivalent to "Very Good."',
        name2: ' The comments reflect the perspectives and objective opinions of the customers.',
    },
    {
        id: 2,
    ...
    return (
        <div className="w-[77%] ml-[170px] mt-[80px] bg-white  flex justify-center">
            <div className='mb-[20px] w-[45%] rounded-3xl bg-white shadow-lg'>
                <div className='w-[100%] flex'>
                    ...
                    <div className="w-[90%] rounded-3xl h-[35px]">
                        <h1 className="p-3 font-bold text-[15px]">Customer Reviews for Dr. Nguyen Thuy Dung: 0 ratings</h1>
                    </div>
                </div>
            ...
            <div className='mb-[20px] w-[45%] rounded-3xl h-[100%] bg-white shadow-lg ml-[5%]'>
                ...
                <div>
                    {Listdata.map((data) => (
                        <div className=" text-[13px] justify-around w-[100%] ml-2 font-light p-[10px]" key={data.id}>
                            <p>{data.name4}</p>
                        </div>
                    ))}
                </div>

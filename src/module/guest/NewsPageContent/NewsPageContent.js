            ...
            <div className=" flex w-[80%] bg-white">
                <div className="w-[20%] min-h-[100px] ">
                    <div className="flex w-[100%] items-center justify-center ">
                        <h1 className="text-[20px] font-bold w-[80%] text-gradientLeft cursor-pointer">Health News</h1>
                        <button
                            type="button"
                    ...
                    {showDiv && (
                        <div>
                            {listnew.map((news) => (
                                <div key={news.id}>
                                    <h2 className="text-[18px] font-bold pb-[8px] cursor-pointer">{news.name}</h2>
                                </div>
                            ))}
                        </div>
                    )}
                    <div className="w-[100%] pb-[20px] pt-[20px]">
                        <h1 className="text-[18px] font-bold  text-gradientLeft cursor-pointer">Hot Announcement</h1>
                    </div>
                    <div className="w-[100%]" >
                        <h1 className="text-[20px] font-bold w-[100%] text-gradientLeft cursor-pointer">Testimonials</h1>
                    </div>
                </div>
                            ...
                            <div className="flex">
                                ...
                                <div className="w-[40%] min-h-[260px] flex justify-center">
                                    <div className="w-[80%] min-h-[30px]">
                                        <div >
                                            <h1 className="text-[20px] font-semibold">Important notes before a general health check</h1>
                                        </div>
                                        <div>
                                            <p>Lorem ipsum dolor sit amet consectetur. Maecenas iaculis dignissim bibendum sit cras non sagittis enim. Sapien at nunc fusce viverra dolor elementum sem quam. Quisque morbi mi congue facilisis.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
const ListDatas = [
  {
    ...
    title:
      "Professor, Ph.D., Dr. Philippe Macaire has dedicated over 30 years in the field of Anesthesiology and Pain Management. Dr. Philippe Macaire has been awarded the title of Professor. He has devoted his career to...",
  },
  {
    id: 2,
    image:
  ...
  return (
    <div>
      ...
      <Slider ref={slider} {...settings}>
        ...
        <div key={2}>
          {docList.slice(3).map((data) => (
            <div
              key={data.id}
              className=" bg-white w-[100%] h-[150px] rounded-[15px] shadow-2xl mb-[15px]"
            >
              <div className="flex p-4 relative" key={data.id}>
                ...
                <div className="w-[85%] pr-[20%]">
                  ...
                  <div>
                    <span className="text-lg font-light">{data.title}</span>
                    <span className=" text-lg text-gradientLeft cursor-pointer">
      ...
      <div className="pt-[20px]" style={{ textAlign: "center" }}>
        <button
          className="button text-[30px] w-10 h-10 bg-gradientLeft mr-[30px]"
          onClick={previous}
        >
          <MdKeyboardArrowLeft className="ml-[2px]" />
        </button>
        <button
          className="button text-[30px] w-10 h-10 bg-gradientLeft"
          onClick={next}
        >

...
import { MdKeyboardArrowRight, MdLanguage, MdOutlineSecurity, MdError } from "react-icons/md";
                    ...
                    <div className="w-[85%] bg-white">
                        <div className="w-[100%] flex h-[100px] ">
                            <div className="w-[20%] flex justify-center items-center ">
                                <img className="rounded-full w-[60px] h-[60px]" src={EnsignAnh}></img>
                            </div>
                            <div className="w-[60%] flex justify-start  items-center">
                                <div className="w-[100%]">
                                    <h1 className="w-[100%] h-[30px] font-bold text-[20px] ">Nguyen Quang Hung</h1>
                                    <p className="w-[100%] h-[30px] text-[#9f9c9c] text-[15px] ">Da Nang City, Viet Nam</p>
                                </div>
                            </div>
                            <div className="w-[20%] flex justify-end">
                                <span><BsPencilSquare className="text-[20px] text-gradientLeft cursor-pointer mt-[30px]" /></span>
                            </div>
                        </div>
                        ...
                        <div className="w-[100%] flex h-[50px]  items-center">
                            ...
                            <div className="w-[50%] flex justify-end">
                                <div className="flex w-[100%]">
                                    <span className="w-[85%] flex justify-end"><p className="text-[#9f9c9c]">All</p></span>
                        ...
                        <div className="w-[100%] h-[150px] ">
                            <div className="flex w-[100%] min-h-[50px] mb-[20px]">
                                <div className="w-[10%] flex">
                                    <img className="rounded-[10px] w-[40px] h-[40px]" src={EnsignAnh}></img>
                                </div>
                                <div className="w-[90%]">
                                    <p className="text-[14px]">Guide to declaring electronic health information through Clinicmate website</p>
                                </div>
                            </div>
                            ...
                            <div className="w-[30%] flex justify-end ">
                                <div className="flex items-center w-[100%]">
                                    <span className="w-[80%] flex justify-end cursor-pointer">
                                        <p className="text-[14px] text-[#bdb9b9]">Not enabled</p>
                                    </span>
                                    <MdKeyboardArrowRight className=" text-[30px] text-[#a4a0a0] w-[20%] cursor-pointer" />
                                </div>
                            </div>

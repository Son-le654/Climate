...
const LoginPage = () => {
    ...
    return ( <
        ...
        <
        InputUsername handleChangeUsername = { handleChangeUsername }
        type = "text"
        ...
        <
        /InputUsername> <
        InputPassword handleChangePassword = { handleChangePassword }
        password = { password }
        name = "password"
        type = "password"
        className = "mt-8"
